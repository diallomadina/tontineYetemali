        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3 cardauth">

                <div class="card-body ">

                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4 text-white ">Connectez vous a votre compte</h5>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="username" class="form-control cardauth" id="yourUsername" required>
                        <div class="invalid-feedback">Veuillez saisir le nom d'utilisateur.</div>
                      </div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Mot de Passe</label>
                      <input type="password" name="password" class="form-control cardauth" id="yourPassword" required>
                    ...
                    <div class="col-3"></div>
                    <div class="col-12">
                      <p class="small mb-0">Vous n'avez pas de compte? <a href="pages-register.html">Creer un compte</a></p>
